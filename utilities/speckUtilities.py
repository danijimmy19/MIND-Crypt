...
def make_train_data(n, nr, diff=(0x0040, 0)):
    """
    This function is used for generating dataset for "random" vs "real" experiment.
    :param n: Number of samples to be generated for the data.
    :param nr: Number of rounds to be used in SPECK32/64
    :param diff: Difference between the two samples
    :return: input data (binary) and corresponding labels (0: random class, 1: real class)
    """
    print(f"generating the dataset for SPECK32/64 for Gohr's \"random\" vs \"real\" experiment ...")
